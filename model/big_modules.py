...
class PixelEncoder(nn.Module):
    def __init__(self, model_cfg: DictConfig):
        ...
        if self.is_resnet:
            ...
            self.layer=VSSM(depths=[2, 2, 4], dims=[96, 192, 384])
...
class MaskEncoder(nn.Module):
    def __init__(self, model_cfg: DictConfig, single_object=True):
        super().__init__()
...
class MaskDecoder(nn.Module):
    def __init__(self, model_cfg: DictConfig):
        ...
        # self.up_16_8 = decoder(up_dims[0], up_dims[1])
        # self.up_8_4 = decoder(up_dims[1], up_dims[2])
    ...
    def forward(self,
        ...
        for i in range(0, num_objects, chunk_size):
            ...
            # p8 = self.up_16_8(p16.squeeze(1), f8).unsqueeze(1)
            # p4 = self.up_8_4(p8.squeeze(1), f4).unsqueeze(1)
